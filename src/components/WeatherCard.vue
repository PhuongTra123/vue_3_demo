...
<template>
    <div :class="place.current.is_day === 1 ? 'bg-day' : 'bg-night'"
        class=" p-10 rounded-lg shadow-lg gap-6 mb-6 relative overflow-hidden">
        <!-- Location & time -->
      ...
      >
        <div class="text-black">
            <div class="flex justify-between">
                ...
                <h1 class="text-2xl mb-1">Delete This Card</h1>
                      <i class="fa-solid fa-close cursor-pointer" @click="handleClose"></i>
            </div>
